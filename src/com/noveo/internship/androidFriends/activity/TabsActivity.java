...
import com.noveo.internship.androidFriends.activity.map_in_fragment.MyMapFragment;
...
//                FragmentStackSupport.class, null);
        ...
        mTabManager.addTab(mTabHost.newTabSpec("flags").setIndicator("", getResources().getDrawable(R.drawable.flags_icon_selector)),
                FlagsSettingActivity.FlagList.class, null);
        mTabManager.addTab(mTabHost.newTabSpec("friends").setIndicator("",getResources().getDrawable(R.drawable.friends_icon_selector)),
                FriendsAndMeetingsActivity.FriendsList.class, null);
